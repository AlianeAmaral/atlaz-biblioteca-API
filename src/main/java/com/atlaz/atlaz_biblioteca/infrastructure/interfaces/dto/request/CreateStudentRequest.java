...
// recomendado para DTOs para ser facilitação

public record CreateStudentRequest (

            @NotBlank(message = "O preenchimento do nome é obrigatório") // @NotBlack: garante preenchimento
            String name,

            @NotBlank(message = "O preenchimento do email é obrigatório")
            @Email(message = "O formato de email é inválido") // @Email: garante que o email tenha formato (@ e .)
            String email,
